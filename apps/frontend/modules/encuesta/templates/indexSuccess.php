...
<div class="wizard" id="some-wizard">
    ...
    <div class="wizard-card" data-cardname="enc_datos_clasificacion">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="#DatosClasificacion" data-toggle="tab">Datos de Clasificación</a></li>
            <li><a href="#profile" data-toggle="tab">Profile</a></li>
            <li><a href="#messages" data-toggle="tab">Messages</a></li>
            <li><a href="#settings" data-toggle="tab">Settings</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="DatosClasificacion">
                <ul id="fields" class="drop-area ui-sortable">
                    <li class="drag-here ui-droppable small"><div>Arrastra y suelta las preguntas aquí</div></li>
                </ul>
            </div>
